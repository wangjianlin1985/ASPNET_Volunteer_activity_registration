...
<uc:header ID="header" runat="server" />
	<div class="col-md-12 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>UserInfo/frontList.aspx">志愿者管理</a></li>
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group" style="display:none;">
				  	 <label for="userInfo_jifen" class="col-md-2 text-right">积分:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_jifen" name="userInfo.jifen" value="0" class="form-control" placeholder="请输入积分">
					 </div>
				  </div>
				  <div class="form-group" style="display:none;">
		          ...
		          <div class="form-group">
		             ...
		             <span onclick="ajaxUserInfoAdd();" class="btn btn-primary bottom5 top5">注册提交</span>
		          </div> 
