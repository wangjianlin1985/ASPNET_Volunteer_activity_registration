...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">志愿者平台</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <!--
                 ...
                 <li><a href="<%=basePath %>Member/frontlist.aspx">团员</a></li>
                 <li><a href="<%=basePath %>SignUp/frontlist.aspx">活动报名</a></li> -->
                <li><a href="<%=basePath %>UserInfo/frontlist.aspx">志愿者风采</a></li>
                <li><a href="<%=basePath %>GroupInfo/frontlist.aspx">组织团体</a></li>
               
                <li><a href="<%=basePath %>HuodongType/frontlist.aspx">活动类型</a></li>
                <li><a href="<%=basePath %>Huodong/frontlist.aspx">志愿活动</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>UserInfo/frontAdd.aspx"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;志愿者注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Member/userFrontlist.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我申请的团体</a></li>
                        <li><a href="<%=basePath %>SignUp/userFrontlist.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我报名的活动</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontAdd.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我要留言</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontlist.aspx"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的留言</a></li>
