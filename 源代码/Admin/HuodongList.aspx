   ...
   <form id="form1" runat="server">
    ...
    <div class="Body_Title">活动管理 》》活动列表</div>
     <div class="Body_Search">
        ...
        发布组织&nbsp;&nbsp;<asp:DropDownList ID="groupObj" runat="server"></asp:DropDownList>  &nbsp;&nbsp;
    ...
    <asp:Repeater ID="RpHuodong" runat="server" onitemcommand="RpHuodong_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="HuodongEdit.aspx?huodongId=<%#Eval("huodongId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("huodongId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
