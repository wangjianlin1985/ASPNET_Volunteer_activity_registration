<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberList.aspx.cs" Inherits="chengxusheji.Admin.MemberList" %>
   ...
   <form id="form1" runat="server">
    ...
    <div class="Body_Title">团员管理 》》团员列表</div>
     <div class="Body_Search">
        申请团体&nbsp;&nbsp;<asp:DropDownList ID="groupObj" runat="server"></asp:DropDownList>  &nbsp;&nbsp;
    ...
    <asp:Repeater ID="RpMember" runat="server" onitemcommand="RpMember_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="MemberEdit.aspx?memberId=<%#Eval("memberId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("memberId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
