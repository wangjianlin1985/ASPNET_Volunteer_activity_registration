<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HuodongGroupList.aspx.cs" Inherits="chengxusheji.Admin.HuodongList" %>
...
<body>
   <form id="form1" runat="server">
    <div class="div_All">
    <div class="Body_Title">活动管理 》》活动列表</div>
     <div class="Body_Search">
        活动类型&nbsp;&nbsp;<asp:DropDownList ID="huodongTypeObj" runat="server"></asp:DropDownList>  &nbsp;&nbsp;
        活动名称&nbsp;&nbsp;<asp:TextBox ID="title" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
        开始时间&nbsp;&nbsp; <asp:TextBox ID="startTime"  runat="server" Width="112px" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>&nbsp;&nbsp;
        结束时间&nbsp;&nbsp; <asp:TextBox ID="endTime"  runat="server" Width="112px" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>&nbsp;&nbsp;
    ...
    <asp:Repeater ID="RpHuodong" runat="server" onitemcommand="RpHuodong_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="HuodongGroupEdit.aspx?huodongId=<%#Eval("huodongId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("huodongId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
