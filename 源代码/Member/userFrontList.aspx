<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userFrontList.aspx.cs" Inherits="Member_frontList" %>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>记录id</td><td>申请团体</td><td>申请时间</td><td>审核状态</td><td>操作</td></tr>
